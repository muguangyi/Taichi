...
namespace ILRuntime.Runtime.Enviorment
{
    ...
    public unsafe struct InvocationContext : IDisposable
    {
        ...
        internal static void InitializeDefaultConverters()
        {
            ...
            {
                // Taichi: Add object to primitive type converter.
                PrimitiveConverter<object>.ToInteger = (a) => (int)a;
                PrimitiveConverter<object>.FromInteger = (a) => a;
                PrimitiveConverter<object>.ToLong = (a) => (long)a;
                PrimitiveConverter<object>.FromLong = (a) => a;
                PrimitiveConverter<object>.ToFloat = (a) => (float)a;
                PrimitiveConverter<object>.FromFloat = (a) => a;
                // end

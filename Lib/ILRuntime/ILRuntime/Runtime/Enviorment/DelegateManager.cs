...
namespace ILRuntime.Runtime.Enviorment
{
    public class DelegateManager
    {
        ...
        // Taichi: Modify method to virtual for GenericDelegateManager to override.
        internal virtual Delegate ConvertToDelegate(Type clrDelegateType, IDelegateAdapter adapter)
        {
        ...
        /// <returns></returns>
        // Taichi: Modify method to virtual for GenericDelegateManager to override.
        internal virtual IDelegateAdapter FindDelegateAdapter(ILTypeInstance instance, ILMethod ilMethod, IMethod method)
        {
